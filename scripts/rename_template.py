...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        ...
        os.rename(
            os.path.join(root_dir_path, "source", "test_project", "test_project"),
            os.path.join(root_dir_path, "source", "test_project", new_name),
        )
        os.rename(
            os.path.join(root_dir_path, "source", "test_project"), os.path.join(root_dir_path, "source", new_name)
        )
